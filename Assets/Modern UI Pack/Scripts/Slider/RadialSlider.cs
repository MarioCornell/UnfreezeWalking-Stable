...
namespace Michsky.MUIP
{
    public class RadialSlider : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            get { return Mathf.Round((SliderValueRaw * valueDisplayPrecision)) / valueDisplayPrecision; }
            set { SliderValueRaw = value; }
        }

        public float SliderValueRaw
        {
            get { return Mathf.Lerp(minValue, maxValue, SliderAngle / 360.0f); }
            set { SliderAngle = (value - minValue) / (maxValue - minValue) * 360.0f; }
        }
        ...
        private void Start()
        {
            ...
            else { SliderAngle = (currentValue - minValue) / (maxValue - minValue) * 360.0f; }
