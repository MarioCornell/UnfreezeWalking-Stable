...
#pragma warning restore 0414
        ...
        public void PausePlayback()
        {
            ...
            // Send events
            ReplayBehaviour.InvokeReplayPlayPauseEvent(scene.ActiveReplayBehaviours, true);
        }
        ...
        public void ResumePlayback()
        {
            ...
            // Send events
            ReplayBehaviour.InvokeReplayPlayPauseEvent(scene.ActiveReplayBehaviours, false);
        }
